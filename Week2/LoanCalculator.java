...
public class LoanCalculator {
	...
	// This code is an excerpt from "An Introduction to Object Oriented Programming with Java" by C. Thomas Wu, Fifth Edition
	
	public static void main(String[] args) {
		
		final int MONTHS_IN_YEAR = 12;
		
		double monthlyPayment, totalPayment, loanAmount, annualInterestRate, monthlyInterestRate;
